  ...
  <div class="main wrap clearfix">
    ...
    <div class="main_right">
      ...
      <div class="page_box about">        
        ...
        <div class="page_main">
          <h3><img src="img/ab_members_h3.png" width="154" height="26" /></h3>
          <div class="text">
            <p>凡曾於聖母書院就讀的同學，都可以成為會員，為贊助會務開支，會員只須入會時繳交會費＄５０。</p>
             <div class="text_tit">
                <ul>
                    <li class="hov" onmouseover="show(this,'cont2','hov')" name="d_1"><a href="#">會員義務</a></li>
                    
                    <li onmouseover="show(this,'cont2','hov')" name="d_2"><a href="#">服務</a></li>
                    
                </ul>
             </div>
             <div class="clear"></div>
             <div class="text_cont" name="cont2">
             	<p>會員須履行關心舊同學，積極參加舊同學會的活動，提出意見，大方服務的責任。</p>
                <p>我們要切切實實地活出本會的口號：</p>
                <p><h1>Living, Loving, Giving</h1></p>
                <p><h1>生活、愛、施予</h1><p>
                <p>真真正正無愧為慈幼大家庭的一份子。</p>
             </div>
             <div class="text_cont" name="cont2" style="display:none;">
             	<h1>關注婦女的服務小組</h1><p></p>
                <p>母校的精神有賴我們發揚光大！ 幹事會希望組織一個舊同學義工服務小組，利用空閒時間，以具體行動，一起去幫助有需要的人， 發揮愛心，讓世界更有情。</p>
