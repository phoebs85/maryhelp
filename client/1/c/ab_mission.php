    ...
    <div class="main_right">
      ...
      <div class="page_box about">
        <div class="instructions">
         <span class="loca">主頁 <span class="lin">></span> 關於我們 <span class="lin">></span>  <span class="now">Mission and Vision</span></span
        </div>
        <div class="page_main">
           <h3><img src="img/ab_mission_h3.png" width="266" height="26" /></h3>
           <div class="text">
               (內容)
           </div>
        </div>
