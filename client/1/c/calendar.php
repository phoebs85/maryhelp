...
<?php include "include_files/_calendar0.php"; ?>

              <div class="calendar">
                <div class="time">
                  <a class="go_top" href="?year=<?php echo $preyear; ?>&month=01"></a><a class="go_prev" href="?year=<?php echo $preyear; ?>&month=<?php echo $premonth; ?>"></a>
                  <span class="month"><?php echo $year."年".$month."月"; ?></span>
                  <a class="go_next" href="?year=<?php echo $preyear; ?>&month=<?php echo $nextmonth; ?>"></a><a class="go_down" href="?year=<?php echo $preyear; ?>&month=12"></a>
                </div>
                <table width="300" border="0" cellpadding="0" cellspacing="0">

<?php include "include_files/_calendar1.php"; ?>

<!--                  <tr>
                    <td class="weekend invalid"></td>
                    <td class="invalid"></td>
                    <td class="invalid"></td>
                    <td class="invalid"></td>
                    <td class="invalid"></td>
...
<?php include "include_files/_calendar2.php"; ?>
