...
<div class="content page">
  <div class="main wrap clearfix">
    ...
    <div class="main_right">
      <div class="slide">
        <img src="Alumni_action/images/page_support.jpg" width="720" height="135"/> 
      </div>
      <div class="page_box contact">
        ...
        <div class="page_main">
          <h3><img src="img/ab_support_h3.png" width="91" height="26" /></h3>          
          <div class="text">
          <p>舊生會作為舊生與母校的橋樑，多年來以義務性質推行各項活動以推動母校精神，實行生活、愛、施予的宗旨。每項活動和計劃得以成功及順利舉行，實有賴校友們的支持，参與和慷慨捐助。</p>
<p>如有興趣捐助或協助，請即下載及填妥<a href="../img/PPA_donation_form.pdf" target="_blank" class="support">捐款表格</a>。若需要更多資料，請與我們聯絡。</p>
